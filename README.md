...
> NOTE: This is not a queue manager and therefore this has nothing to do with Laravel's queue component. Also note that Laravel 5 has an integrated [job component](https://laravel.com/docs/5.4/schedulingg) that works similar to this one.
